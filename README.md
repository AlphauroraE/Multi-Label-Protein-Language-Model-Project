...
- Viral protein sequence is very small proportion
- Theory: ESM2 has not learned enough to answer questions yet
...
- ESM for MaskedLM is for pre-training (for second experment)
...
- Also doing second part is better, then complete story
